        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-3 py-3">
                <div class="container mx-auto py-8 mt-5">
                    <form action="{{ route('student.index') }}" method="GET" class="mb-5">
                ...
                <div class="container mx-auto py-8">
                    <a href="{{ route('student.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-3">
                        Crear Estudiante
                    </a>
                </div>
                <div class="container mx-auto py-8">
                        ...
                        <table class="min-w-full table-auto">
                            <thead>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th class="px-4 py-2 text-left text-gray-600 font-semibold"># Documento</th>
                                    <th class="px-4 py-2 text-left text-gray-600 font-semibold"># Contacto</th>
                            ...
                            <tbody class="text-gray-700 text-sm">
                                ...
                                <tr class="bg-gray-100">
                                    ...
                                    <td class="border px-4 py-2">{{ $student->docId }}</td>
                                    <td class="border px-4 py-2">{{ $student->contactPhone }}</td>
                                    <td class="border px-4 py-2">
                                        <a href="{{ route('student.show', $student) }}" class="text-blue-500 hover:text-blue-700">Ver |</a>
                                        <a href="{{ route('student.edit', $student) }}" class="text-blue-500 hover:text-blue-700">Editar |</a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-4">No se encontraron estudiantes.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
