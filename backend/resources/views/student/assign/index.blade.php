        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="max-w-2xl mx-auto mt-6">
                    <h2 class="text-xl font-semibold mb-4">Asignar Categoría con Historial</h2>

                    <form action="{{ route('assignStudent.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label for="category_id" class="block text-gray-700">Seleccionar Estudiante</label>
                            <select name="student_id" id="student_id" class="form-input mt-1 block w-full">
                                <option></option>
